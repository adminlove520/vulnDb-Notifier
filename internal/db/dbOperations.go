...
import (
	...
	"github.com/adminlove520/vulnDb-Notifier/internal/discord"
	"github.com/adminlove520/vulnDb-Notifier/internal/errors"
	"github.com/adminlove520/vulnDb-Notifier/internal/slack"
...
func InsertData(dbConn *sql.DB, vulnTitle string, link string, published string, categories string, description string, slackWebhook string, discordWebhook string) error {
	...
	if discordWebhook != "" {
		err = discord.NotifyDiscord(vulnTitle, link, published, categories, description, discordWebhook)
		if err != nil {
			//log.Println("InsertData: Failed to send Discord notification:", err)
			return err
		}
	}
